...
-- We set up the datasets for both instruments defined in resources/sql/testbase/instrument
...
INSERT INTO dataset
  (id, instrument_id, name, start, end, min_longitude, max_longitude, min_latitude, max_latitude, status, status_date, nrt, exported)
  VALUES
  (11, 2, 'D1', 1676851200000, 1678406400000, -10, 10, -10, 10, 50, 1718197125000, 0, 0);
...
INSERT INTO dataset
  (id, instrument_id, name, start, end, min_longitude, max_longitude, min_latitude, max_latitude, status, status_date, nrt, exported)
  VALUES
  (12, 2, 'D2', 1683676800000, 1684540800000, -10, 10, -10, 10, 50, 1718197125000, 0, 0);
...
INSERT INTO dataset
  (id, instrument_id, name, start, end, min_longitude, max_longitude, min_latitude, max_latitude, status, status_date, nrt, exported)
  VALUES
  (13, 2, 'D3', 1686355200000, 1687219200000, -10, 10, -10, 10, 50, 1718197125000, 0, 0);
...
INSERT INTO dataset
  (id, instrument_id, name, start, end, min_longitude, max_longitude, min_latitude, max_latitude, status, status_date, nrt, exported)
  VALUES
  (14, 2, 'D4', 1688947200000, 1689811200000, -10, 10, -10, 10, 50, 1718197125000, 0, 0);
