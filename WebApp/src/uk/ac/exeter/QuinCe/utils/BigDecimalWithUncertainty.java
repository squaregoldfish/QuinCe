...
public record BigDecimalWithUncertainty(BigDecimal value, Float uncertainty)
  ...
  public BigDecimalWithUncertainty add(BigDecimal addend) {
    return add(new BigDecimalWithUncertainty(addend));
  }
  ...
  public BigDecimalWithUncertainty multiply(
    ...
    Float uncertainty = result.multiply(relativeUncertainty(this, multiplier))
      .floatValue();
  ...
  public BigDecimalWithUncertainty multiply(BigDecimal multiplier) {
    return multiply(new BigDecimalWithUncertainty(multiplier));
  }
  ...
  public BigDecimalWithUncertainty divide(BigDecimalWithUncertainty divisor) {
    ...
    Float uncertainty = result.multiply(relativeUncertainty(this, divisor))
      .floatValue();
  ...
  public BigDecimalWithUncertainty divide(BigDecimalWithUncertainty divisor,
    ...
    BigDecimal result = value.divide(divisor.value, scale, roundingMode);
    Float uncertainty = result.multiply(relativeUncertainty(this, divisor))
      .floatValue();
   ...
   *         result.
   */
  public BigDecimalWithUncertainty divide(BigDecimal divisor, int scale,
    RoundingMode roundingMode) {

    return divide(new BigDecimalWithUncertainty(divisor), scale, roundingMode);
  }
  ...
  public BigDecimalWithUncertainty divide(BigDecimalWithUncertainty divisor,
    RoundingMode roundingMode) {
    BigDecimal result = value.divide(divisor.value, roundingMode);
    Float uncertainty = result.multiply(relativeUncertainty(this, divisor))
      .floatValue();
   ...
   */
  private static BigDecimal relativeUncertainty(BigDecimalWithUncertainty a,
     ...
     */
    BigDecimal aPart = new BigDecimal(a.uncertainty).divide(a.value).pow(2);
    BigDecimal bPart = new BigDecimal(b.uncertainty).divide(b.value).pow(2);

    BigDecimal partSum = aPart.add(bPart);
    return partSum.sqrt(MathContext.DECIMAL128);
  }
  ...
  /**
   * Return a new {@link BigDecimalWithUncertainty} with the specified scale and
   * rounding mode.
   * 
   * @param newScale
   *          The new scale.
   ...
   */
  public BigDecimalWithUncertainty setScale(int newScale,
    RoundingMode roundingMode) {
    return new BigDecimalWithUncertainty(value.setScale(newScale, roundingMode),
      uncertainty);
  }
